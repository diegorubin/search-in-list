...
#define SWIG_init    boot_Search

#define SWIG_name   "Searchc::boot_Search"
#define SWIG_prefix "Searchc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_Search_var::
class _wrap_Search_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
